...
<reference>
@/Users/macbbook/DCP/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/macbbook/DCP/.claude/get-shit-done/references/user-profiling.md` to load:
